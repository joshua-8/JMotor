#ifndef J_MOTOR_DRIVER_ESP32_L293_TWO_PINS_H
#define J_MOTOR_DRIVER_ESP32_L293_TWO_PINS_H
 ...
 * Unlike JMotorDriverEsp32HBridge, this driver uses a single LEDc channel, so this is better than JMotorDriverEsp32HBridge.
 */
class JMotorDriverEsp32L293TwoPins : public JMotorDriver {
protected:
    bool enabled = false;
    bool reverse;
    bool invertSignals;
...
public:
     ...
     */
    JMotorDriverEsp32L293TwoPins(byte _ledCChannel, byte _pinPos, byte _pinNeg, bool _reverse = false, int _freq = 2000, int _resolution = 12, bool _invertSignals = false)
    {
        pinPos = _pinPos;
        pinNeg = _pinNeg;
        PWM_FREQ = _freq;
...
#endif // J_MOTOR_DRIVER_ESP32_L293_TWO_PINS_H
