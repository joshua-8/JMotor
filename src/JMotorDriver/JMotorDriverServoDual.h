#ifndef J_MOTOR_DRIVER_SERVO_DUAL_H
#define J_MOTOR_DRIVER_SERVO_DUAL_H
#include "JMotorDriverServo.h"
#include <Arduino.h>
/**
 * @brief  control two JMotorDriverServos as if they are one driver
 * @note  one (or both) of the drivers may be another dual driver allowing for controlling more than two servos together
 */
class JMotorDriverServoDual : public JMotorDriverServo {
public:
